...
public class seedx {
    ...
    //private static Bool ENDIAN	 = BIG;	// IBM370, Motorola 68000, Pyramid (��κ���?RISC ���?

    /* �ʱ� ȯ�� ���� */
    private static int NoRounds = 16;
    private int NoRoundKeys = 32;        //(NoRounds*2)
    private static int SeedBlockSize = 16;   // in bytes
    ...
    /* Encrypt */
    public static void SeedEncrypt(char pbData[], int pdwRoundKey[], char outData[]) {
        int L0[] = new int[1];
        int L1[] = new int[1];
        int R0[] = new int[1];
        int R1[] = new int[1];
    ...
    public static void SeedDecrypt(char pbData[], int pdwRoundKey[], char outData[]) {
        int L0[] = new int[1];
        int L1[] = new int[1];
        int R0[] = new int[1];
        int R1[] = new int[1];
    ...
    public static void SeedEncRoundKey(int pdwRoundKey[], char pbUserKey[]) {
        int A[] = new int[1];
        int B[] = new int[1];
        int C[] = new int[1];
        int D[] = new int[1];
    ...
    public static void encrypt(char[] src, char[] dest, int len, int[] pdwRoundKey) {

        char[] srcTemp = new char[SeedBlockSize];
        char[] destTemp = new char[SeedBlockSize];
        char[] result = new char[len];
        for (int i = 0; i < len / SeedBlockSize; i++) {
            System.arraycopy(src, i * SeedBlockSize, srcTemp, 0, SeedBlockSize);
            seedx.SeedEncrypt(srcTemp, pdwRoundKey, destTemp);
            System.arraycopy(destTemp, 0, result, i * SeedBlockSize, SeedBlockSize);
        }
        System.arraycopy(result, 0, dest, 0, len);
        Arrays.fill(srcTemp, (char) 1);
        Arrays.fill(destTemp, (char) 1);
        Arrays.fill(result, (char) 1);
        Arrays.fill(srcTemp, (char) 9);
        Arrays.fill(destTemp, (char) 9);
        Arrays.fill(result, (char) 9);
        Arrays.fill(srcTemp, (char) 0);
        Arrays.fill(destTemp, (char) 0);
        Arrays.fill(result, (char) 0);
    }


    public static void decrypt(char[] src, char[] dest, int len, int[] pdwRoundKey) {
        ...
        for (int i = 0; i < len / SeedBlockSize; i++) {
            System.arraycopy(src, i * SeedBlockSize, srcTemp, 0, SeedBlockSize);
            seedx.SeedDecrypt(srcTemp, pdwRoundKey, destTemp);
            System.arraycopy(destTemp, 0, result, i * SeedBlockSize, SeedBlockSize);
        }
        System.arraycopy(result, 0, dest, 0, len);
        Arrays.fill(srcTemp, (char) 1);
